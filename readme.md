...
travail fini le jeu marche correctement toute les fonctionnalités sont présentes ajout d'une fonctionalité qui fait perdre des points si on touche un oiseau

### Pour lancer le jeu il faut faire dans le dossier tp3:
- `npm install`
- `npm run build`
- et enfin lancer de index.html dans le dossier dist
